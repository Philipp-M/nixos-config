...
call <sid>hi("MatchParen",    "", s:gui02, "", s:cterm02,  "bold", "")
...
" disable background color for transparency if desired
if exists("g:base16_transparent_background") && g:base16_transparent_background == 1

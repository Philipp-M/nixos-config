  ...
  xdg.configFile."niri/config.kdl".text = ''
    ...
    layout {
        ...
        focus-ring {
            ...
            //
            // active-gradient from="#80c8ff" to="#000" angle=45
    ...
    binds {
        ...
        // Mod+Space hotkey-overlay-title="Run an Application: fuzzel" { spawn "${pkgs.fuzzel}/bin/fuzzel"; }
        Mod+Space { spawn "rofi" "-show" "run"; }
        ...
        Mod+H     { focus-window-or-workspace-up; }
        Mod+Shift+K     { move-window-down-or-to-workspace-down; }
        Mod+Shift+H     { move-window-up-or-to-workspace-up; }
        ...
        Mod+Shift+Ctrl+H     { move-column-to-monitor-up; }

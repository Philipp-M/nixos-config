    ...
    programs.zed-editor = {
      ...
      userKeymaps = [
        ...
        }
        {
          ...
          bindings = {
            "'" = "vim::RepeatFind";
            "backspace" = [ "action::Sequence" [ "vim::HelixCollapseSelection" "vim::HelixKeepNewestSelection" ] ];
            "ctrl-e" = "vim::LineDown";
            "ctrl-x" = "vim::HelixSelectLine";
            "ctrl-y" = "vim::LineUp";
            "," = [ "action::Sequence" [ "vim::HelixCollapseSelection" "vim::HelixKeepNewestSelection" ] ];
            "d" = "editor::Cut";
            "g j" = "vim::StartOfLine";
            "h" = [ "vim::Up" { display_lines = true; } ];
            "[ c" = "vim::PreviousComment";
            "[ d" = "editor::GoToPreviousDiagnostic";
            "[ e" = "editor::MoveToStartOfExcerpt";
            "[ f" = "vim::PreviousMethodStart";
            "[ g" = "editor::GoToPreviousHunk";
            "[ p" = "vim::StartOfParagraph";
            "[ shift-g" = "editor::GoToPreviousChange";
            "[ space" = "vim::InsertEmptyLineAbove";
            "j" = "vim::WrappingLeft";
            "k" = [ "vim::Down" { display_lines = true; } ];
            "] c" = "vim::NextComment";
            "] d" = "editor::GoToDiagnostic";
            "] e" = "editor::MoveToStartOfNextExcerpt";
            "] f" = "vim::NextMethodStart";
            "] g" = "editor::GoToHunk";
            "] p" = "vim::EndOfParagraph";
            "] shift-g" = "editor::GoToNextChange";
            ...
            "space shift-p" = [ "vim::HelixPaste" { before = true; } ];
            ...
            "space t w" = [ "action::Sequence" [ "vim::HelixCollapseSelection" "vim::HelixKeepNewestSelection" ] ];
